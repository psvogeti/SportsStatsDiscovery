...
Before the draft, the NBA assigns the non-playoff teams to a Lottery designation. The Lottery is meant to classify, as of today, the top 11 draft picks on the draft board. The idea is that the teams that have the worst finishes during the regular season are guaranteed an instant impact player from the Lottery draft class. This process continues each year with the intent of creating a competitive league for all teams. 
